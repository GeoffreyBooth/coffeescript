...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield'), o('Import'), o('Export')],
    Yield: [
      o('YIELD', function() {
